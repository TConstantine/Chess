...
import constantine.theodoridis.android.game.chess.data.datasource.*
...
class DataSourceModule {
	@Provides
	fun provideDatabaseDataSource(database: ApplicationDatabase): DatabaseDataSource {
		return SQLiteDatabaseDataSource(database)
	}
